...
- 🧩 **Instrukcje krok po kroku** — jak coś skonfigurować lub zainstalować  
- 📦 **Notatki z projektów** — homelab, sieci, automatyzacje, mikrokontrolery  
- 💡 **Tipy, skróty i obejścia problemów**, które pojawiły się „po drodze”  
- 🧪 **Eksperymenty** — co testowałem i jakie były wyniki  

Treści mogą być czasem chaotyczne, surowe albo pisane na szybko — ale zawsze działają.
...
Dostępne na zasadach **MIT License** — rób z tym, co chcesz.
